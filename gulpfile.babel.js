 ...
 */
const project = {
  name: 'Hiwelo\'s Blog Theme', // project name for gulp-notify
  url: 'http://blog.hiwelo.local', // project dev url
  preprocessor: {
...
const vendors = {
  list: [
    ...
    // `${paths.vendors}/masonry-layout/dist/masonry.pkgd.min.js`,
    `${paths.vendors}/imagesloaded/imagesloaded.pkgd.min.js`,
  ],
};
/*
